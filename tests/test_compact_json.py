...
def test_compact_json_saving_and_roundtrip():
    ...
    with tempfile.TemporaryDirectory() as tmp_dir:
        ...
        loaded_project, _, _ = ProjectService.load_and_migrate_project(str(save_path))
...
def test_open_indented_json_and_save_as_compact():
    ...
    with tempfile.TemporaryDirectory() as tmp_dir:
        ...
        loaded_from_indent, _, _ = ProjectService.load_and_migrate_project(str(indented_path))
        ...
        # Reopen and compare
        final_project, _, _ = ProjectService.load_and_migrate_project(str(compact_path))
